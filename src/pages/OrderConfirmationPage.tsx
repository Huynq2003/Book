...
const OrderConfirmation: React.FC = () => {
  ...
  // Check if orderInfo is available before rendering the page content
  if (!orderInfo) {
    return <p className="text-center text-lg text-gray-600">Không có đơn hàng nào cả.</p>; // Message when no order exists
  }
